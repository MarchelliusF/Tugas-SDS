...
//membuat endpoint Insert Data sesuai dengan Colection Postman
func InsertData(c *fiber.Ctx) error {

	//menulis Jawaban Code di Sini :))
...
//melengkapi Code Berikut untuk untuk Mengambil data untuk semua user - user
...
//melengkapi Code berikut Untuk Mengambil data dari id_user berdasarkan Parameter
...
//update data user berdasarkan id_user yang di tempatkan di parameter
